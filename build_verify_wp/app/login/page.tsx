...
import { Suspense, type Dispatch, type FormEvent, type SetStateAction, useMemo, useState } from "react";
...
function LoginPageInner() {
    ...
    return <LoginCardContent error={error} helperText={helperText} email={email} password={password} isSubmitting={isSubmitting} setEmail={setEmail} setPassword={setPassword} handleSubmit={handleSubmit} />;
}
...
function LoginPageFallback() {
    return (
        <LoginCardContent
            error={null}
            helperText="Sign in with your assigned account to continue."
            email=""
            password=""
            isSubmitting={false}
            setEmail={() => undefined}
